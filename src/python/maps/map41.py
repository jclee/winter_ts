...
def to39():
    ...
    yield from system.engineObj.mapSwitchTask('map39.ika-map', (38 * 16, y))
    
def to42():
    yield from system.engineObj.mapSwitchTask('map42.ika-map', (system.engineObj.player.x - 16, 1 * 16))
